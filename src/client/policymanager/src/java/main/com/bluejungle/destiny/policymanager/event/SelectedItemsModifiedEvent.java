...
/**
 * SelectedItemsModifiedEvent is an
 * {@see com.bluejungle.destiny.policymanager.event.IEvent} implementation
 * associated with the event type,
 * {@see EventType#SELECTED_ITEMS_MODIFIED_EVENT}
 * 
 * @author sgoldstein
 * @version $Id:
 *          //depot/main/Destiny/main/src/client/policymanager/src/java/main/com/bluejungle/destiny/policymanager/event/SelectedItemsModifiedEvent.java#1 $
 */
...
public class SelectedItemsModifiedEvent implements IEvent {
     ...
     * @param selectedItems
     */
    public SelectedItemsModifiedEvent(Set rawSelectedItems) {
