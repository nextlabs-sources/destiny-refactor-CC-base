 ...
 * 
 */
public class PolicyEditor extends EditorPanel {
    ...
    private Label bodySectionLabel;
    ...
    private Composite resourceSection, connectionTypeSection, enforcementDateSection, recurrentDateSection, connectionTypeLabel, enfDateLabel, recDateLabel;
    ...
    public PolicyEditor(Composite parent, int style, IDPolicy domainObject) {
        ...
        addDisposeListener(new DisposeListener() {
            ...
            public void widgetDisposed(DisposeEvent e) {
                eventManager.unregisterListener(objectModifiedListner, ContextualEventType.POLICY_OR_COMPONENT_MODIFIED_EVENT, PolicyEditor.this.domainObject);
            }
        });
    }
    ...
    protected void initializeSubject() {
        ...
        subjectSectionLabel.setText(EditorMessages.POLICYEDITOR_SUBJECT);
        ...
        Composite desktopLabel = getPartLabel(EditorMessages.POLICYEDITOR_COMPUTER, subjectComposite, userLabel, hostComp);
        ...
        if (!isAccess()) {
            ...
            Composite appLabel = getPartLabel(EditorMessages.POLICYEDITOR_APPLICATION, subjectComposite, desktopLabel, appComp);
    ...
    private void updateObligation() {
        ...
        if (effect == 2) {
            ...
            data.top = new FormAttachment(resourceSection, SPACING);
            data.height = 0;
            data.width = 0;
    ...
    protected void initializeBody() {
        ...
        bodySectionLabel = new Label(bodyComposite, SWT.NONE);
        bodySectionLabel.setText(EditorMessages.POLICYEDITOR_PERFORM_THE_FOLLOWING);
        bodySectionLabel.setBackground(getBackground());
        ...
        FormData separatorData = new FormData();
        separatorData.top = new FormAttachment(bodySectionLabel, 2);
        separatorData.left = new FormAttachment(0, 100, SPACING);
        separatorData.right = new FormAttachment(100);
        ...
        onResourceLabel.setBackground(getBackground());
        onResourceLabel.setForeground(ColorBundle.CE_MED_BLUE);
        sectionLabelData = new FormData();
        sectionLabelData.left = new FormAttachment(0, 100, SPACING);
        sectionLabelData.top = new FormAttachment(actionComp, SPACING);
        ...
        separatorData.top = new FormAttachment(onResourceLabel, 2);
        separatorData.left = new FormAttachment(0, 100, SPACING);
        separatorData.right = new FormAttachment(100);
        separator.setLayoutData(separatorData);

        resourceSection = new Composite(bodyComposite, SWT.NONE);
        Composite resourceLabel = getPartLabel(EditorMessages.POLICYEDITOR_TARGET, bodyComposite, separator, resourceSection);
        ...
        sectionLabelData = new FormData();
        sectionLabelData.left = new FormAttachment(0, 100, SPACING);
        sectionLabelData.top = new FormAttachment(resourceSection, SPACING);
        ...
        separatorData = new FormData();
        separatorData.top = new FormAttachment(dateSectionLabel, 2);
        separatorData.left = new FormAttachment(0, 100, SPACING);
        separatorData.right = new FormAttachment(100);
        separatorCondition.setLayoutData(separatorData);
    ...
    private void initializeResources(Composite resourceSection) {
        ...
        rsrcSrcComp = new CompositionControl(resourceSection, SWT.NONE, EditorMessages.POLICYEDITOR_RESOURCE_COMPONENT, "" /* getObjectTypeLabelText() */, getControlDomainObject(CONTROL_ID_DOC_SRC, getDomainObject()), this, CONTROL_ID_DOC_SRC,
        ...
        tgtLabel.setEnabled(isEditable());
        tgtLabel.setBackground(background);

        rsrcTgtComp = new CompositionControl(resourceSection, SWT.NONE, EditorMessages.POLICYEDITOR_RESOURCE_COMPONENT, "" /* getObjectTypeLabelText() */, getControlDomainObject(CONTROL_ID_DOC_TARGET, getDomainObject()), this, CONTROL_ID_DOC_TARGET,
                isEditable(), false, true, new String[] { EditorMessages.POLICYEDITOR_INTO, EditorMessages.POLICYEDITOR_OUTSIDE }, SpecType.RESOURCE, ComponentEnum.RESOURCE, null);
    ...
    private class DailyScheduleTimeRow extends TimeRow {
        ...
        public void populateContents(Composite contents) {
            ...
            fromLabel.setEnabled(isEditable());
    ...
    protected String getPolicyType() {
        return PolicyEnum.DOCUMENT_POLICY.toString();
    }
}
