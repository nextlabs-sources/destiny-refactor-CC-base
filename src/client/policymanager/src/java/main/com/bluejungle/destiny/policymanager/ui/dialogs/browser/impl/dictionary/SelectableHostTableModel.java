 ...
 * implementation for Host Subjects
 * 
 * @author sgoldstein
 * @version $Id:
 *          //depot/main/Destiny/main/src/client/policymanager/src/java/main/com/bluejungle/destiny/policymanager/ui/dialogs/browser/impl/userbrowser/SelectableHostTableModel.java#3 $
 */

public class SelectableHostTableModel implements ISelectableLeafObjectTableModel {
    ...
    static {
        ...
        COLUMN_HEADERS.add(BrowserMessages.SELECTABLEHOSTTABLEMODEL_DNSHOSTNAME);
    }
