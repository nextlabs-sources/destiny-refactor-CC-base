...
/*
 * All sources, binaries and HTML pages (C) copyright 2004-2013 by NextLabs, Inc.,
...
public class TrackingLogEntryV2 extends BaseLogEntry implements Externalizable, TrackingLogEntryWrapper {
    ...
    public TrackingLogEntryV2(FromResourceInformation fromResourceInfo,
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        // now read the custom attributes
        int nbAttr = in.readInt();

        if (nbAttr == 0) {
            customAttr = null;
        } else {
            customAttr = new DynamicAttributes();
            for (int i = 0; i < nbAttr; i++){
                String keyValuePair = in.readUTF();
                int index = keyValuePair.indexOf(",");
                String key = keyValuePair.substring(0, index);
                String value = keyValuePair.substring(index+2);
                this.getCustomAttr().put(key, value);
            }
        }
    }
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        AttributeExternalizer.externalizeResourceAttributes(out, getCustomAttr());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TrackingLogEntryV2)) {
            return false;
        }
        ...
        TrackingLogEntryV2 entry = (TrackingLogEntryV2) obj;
    ...
    public String toString() {
        StringBuffer rv = new StringBuffer("TrackingLogEntryV2[");
