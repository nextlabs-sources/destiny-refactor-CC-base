 ...
 * 
 */
public class PolicyActivityInfoV2 implements Externalizable {
    ...
    PolicyActivityInfoV2() {
    }

    /**
     * Copy constructor used by PolicyEvaluatorImpl
     */
    public PolicyActivityInfoV2(PolicyActivityInfoV2 orig) {
    ...
    public PolicyActivityInfoV2(FromResourceInformation fromResourceInfo, 
            ToResourceInformation toResourceInfo, 
            String userName, 
            long userId, 
            String hostName, 
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PolicyActivityInfoV2)) {
            return false;
        }
        ...
        PolicyActivityInfoV2 info = (PolicyActivityInfoV2) obj;
    ...
    public String toString() {
        StringBuffer rv = new StringBuffer("PolicyActivityInfoV2[");
