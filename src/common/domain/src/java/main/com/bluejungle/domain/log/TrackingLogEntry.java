...
public class TrackingLogEntry extends BaseLogEntry implements Externalizable {
    ...
    public TrackingLogEntry(FromResourceInformation fromResourceInfo,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TrackingLogEntry)) {
            return false;
        }
        ...
        TrackingLogEntry entry = (TrackingLogEntry) obj;
    ...
    public String toString() {
        StringBuffer rv = new StringBuffer("TrackingLogEntry[");
