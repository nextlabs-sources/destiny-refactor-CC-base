...
SELECT username, first_name, last_name, DOMAIN_ID, PRIMARY_GROUP_ID, CONVERT(NVARCHAR(1000), PASSWORD, 2) as password, INITLOGIN_DONE FROM SUPER_APPLICATION_USER
UNION ALL
SELECT username, first_name, last_name, DOMAIN_ID, PRIMARY_GROUP_ID, CONVERT(NVARCHAR(1000), PASSWORD, 2) as password, INITLOGIN_DONE FROM APPLICATION_USER
