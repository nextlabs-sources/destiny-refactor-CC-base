...
SELECT username, first_name, last_name, DOMAIN_ID, PRIMARY_GROUP_ID, encode(password::bytea, 'hex') as password, INITLOGIN_DONE FROM SUPER_APPLICATION_USER
UNION ALL
SELECT username, first_name, last_name, DOMAIN_ID, PRIMARY_GROUP_ID, encode(password::bytea, 'hex') as password, INITLOGIN_DONE FROM APPLICATION_USER
