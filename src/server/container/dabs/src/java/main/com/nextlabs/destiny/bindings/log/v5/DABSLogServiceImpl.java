 ...
 *
 * @author amorgan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1/main/src/server/container/dabs/src/java/main/com/nextlabs/destiny/bindings/log/v5/DABSLogServiceImpl.java#1 $:
 */
...
public class DABSLogServiceImpl implements LogServiceIF {
    ...
    public LogStatus logPolicyActivityV4(String request) throws RemoteException {
	    ...
	    public LogStatus logPolicyActivityV5(String request) throws RemoteException {
    ...
    private PolicyActivityLogEntryV4[] decodePAV4Request(String request) throws IOException, ClassNotFoundException {
        ObjectInputStream ois = DABSLogServiceWSConverter.decodeData(request);
        int numEntries = ois.readInt();
    ...
    private PolicyActivityLogEntryV5[] decodePAV5Request(String request) throws IOException, ClassNotFoundException {
        ObjectInputStream ois = DABSLogServiceWSConverter.decodeData(request);
        int numEntries = ois.readInt();
