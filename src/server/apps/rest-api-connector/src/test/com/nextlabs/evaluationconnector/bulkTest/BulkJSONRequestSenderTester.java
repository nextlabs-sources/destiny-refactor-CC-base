...
public class BulkJSONRequestSenderTester {
	...
	private String success_request_file = "./sample_requests/SampleJSONRequest_SubjectTag.txt";
	private String missing_id_request_file = "./sample_requests/SampleJSONRequest_MissingID.txt";
	private String allowed_request_file = "./sample_requests/SampleJSONRequest_AllowedFile.txt";
	private String duplicate_subject_request_file = "./sample_requests/SampleJSONRequest_DuplicateSubjectTag.txt";
	private String deny_request_file = "./sample_requests/SampleJSONRequest_DenyFile.txt";
	private String request_pod1 = "./sample_requests/SampleJSONRequest_POD_1.txt";
	private String request_pod2 = "./sample_requests/SampleJSONRequest_POD_2.txt";
	...
	public void sendBulkMessages() throws ClientProtocolException, IOException,
		...
		requestData.add(loadRequestData(request_pod1));
		requestData.add(loadRequestData(request_pod2));
				...
				public void run() {
					...
					try {
						...
						if (log.isInfoEnabled())
							log.info(String
									.format("%s, Thread Id:[%s],  BulkJSONRequestSenderTest --------------------------------------------->  Single Request end to end Time : %d milis",
